                ...
                <>
                    ...
                    <div className={utilStyles.workdetailarea}>
                        <div className={utilStyles.workdetailarea_container}>
                            <div className={utilStyles.workdetail_container}>
                                <div className={utilStyles.workdetail}>
                                    ...
                                    <div className={utilStyles.workdownload}>
                                        Projectfile
                                    <Link href={PostData.downdloadlink}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
